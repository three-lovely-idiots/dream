layui.use(['form','layer','laydate','table','laytpl','layedit'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'title', title: '预约名称', width:60, align:"center"},
            {field: 'image_id', title: '预约主图', width:180, align:"center",templet:function(d){
            ...
            {field: 'appoint_days', title: '可预约天数', width:150},
            {field: 'isshow', title: '是否启用', align:'center', templet:function(d){
