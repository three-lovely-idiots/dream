            ...
            $.get("getall",function(res){
                ...
                setTimeout(function(){
                    for(var i=imgNums*(page-1); i<maxPage; i++){
                        imgList.push('<li><img layer-src="'+data[i].url+'"  src="'+data[i].url+'"  alt="'+data[i].id+'"><div class="operate"><div class="check"><input type="radio" name="img" lay-filter="choose" lay-skin="primary" title="'+data[i].id+'"></div><i class="layui-icon img_del">&#xe640;</i></div></li>');
                    }
